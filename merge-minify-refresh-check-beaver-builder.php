<?php
/**
 * Plugin Name: MMR Disable for Beaver Builder Editor
 * Plugin URI: https://wordpress.org/plugins/merge-minify-refresh
 * Description: Disable MMR when Beaver Builder Editor is active
 * Version: 1.0.0
...
function should_mmr_beaver_builder($should_mmr)
{
...
add_filter('should_mmr', 'should_mmr_beaver_builder');